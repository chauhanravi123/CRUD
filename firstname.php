...
<meta name="viewport" content="width=device-width, initial-scale=1">
   ...
   <div class="container">    
	  <form action="firstname.php" method="POST">	 
	      ...
	      <input type="email" name="txtema" placeholder="enter email" class="container mt-3" required>
	      <input type="number" name="txtmno" placeholder="enter mobileno" class="container mt-3" required>
	      <textarea name="addres" name="addres"  rows="5" cols="40"placeholder="enter your addres"  class="container mt-3" required>
		   </textarea>
